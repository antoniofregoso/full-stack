...
class CoreTeam(CoreAudit, SQLModel, table=True):
    __tablename__ = "core_teams"
    __table_args__ = (
        UniqueConstraint("system_id", "code", name="uq_core_teams_system_code"),
    )

    id: Optional[int] = Field(default=None, primary_key=True, nullable=False)
    system_id: int = Field(foreign_key="core_systems.id")
    ...
    system: "CoreSystem" = Relationship(back_populates="teams")
    modules: list["CoreModule"] = Relationship(back_populates="team")
