...
class CoreSystem(CoreAudit, SQLModel, table=True):
    __tablename__ = "core_systems"
    __table_args__ = (
        UniqueConstraint("code", name="uq_core_systems_code"),
    )
    ...
    teams: list["CoreTeam"] = Relationship(back_populates="system")
